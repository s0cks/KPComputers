                          ...
                          (cond ((string=? (e:name) "char")
                                 (cond ((string=? ((e:args) 0) "__enter__")
                                       ...
                                       ((string=? ((e:args) 0) "__right__")
                                        (cond ((not menu)
                                               (cond ((< x (+ (string-length (lines:get (- y 1))) 1))
                                                      (set! x (+ x 1)))
                                                     ((and (= x (+ (string-length (lines:get (- y 1))) 1)) (< y (lines:size)))
                                                      (set! x 1)
                                                      (set! y (+ y 1)))))
                                              (else
                                                  (set! menuItem (+ menuItem 1))
                                       ...
                                       ((string=? ((e:args) 0) "__ctrl__")
                                        ...
                                        (redrawMenu)
                                        (run))
                                       ((string=? ((e:args) 0) "__ctrlv__")
                                        (define sLine (lines:get (- y 1)))
                                        (lines:set (- y 1) (str:combine (str:sstring sLine 1 (- x 1)) (os:getClipboard) (str:sstring sLine x)))
                                        (redrawLine (- y 1))
                                        (set! x (+ x (string-length (os:getClipboard))))
                                        (setCursorPos x y)
                                        (run))
                                       (else
                                           (define s (lines:get (- y 1)))
